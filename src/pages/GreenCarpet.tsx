    ...
    return (
        <div className="flex flex-col h-full w-full bg-[#050505] text-white overflow-hidden font-display relative">
            ...
            <div className="flex items-center justify-between p-6 pt-12 shrink-0 z-20">
                ...
                <div className="flex flex-col items-center">
                    <div className="flex items-center gap-2 px-4 py-1.5 bg-green-500/10 rounded-full border border-green-500/20">
                        ...
                        <span className="text-[10px] font-black tracking-widest uppercase text-green-400">{t('greencarpet.live')}</span>
                    </div>
                </div>
            ...
            <div className="px-6 mb-8 text-center">
                <h1 className="text-4xl font-black uppercase italic tracking-tighter leading-none mb-2">{t('greencarpet.social_impact')}</h1>
                <p className="text-white/40 text-[10px] font-bold uppercase tracking-[0.3em]">{t('greencarpet.transforming_steps')}</p>
            </div>
                ...
                {activeTab === 'community' ? (
                    <div className="space-y-6">
                        ...
                        <div className="bg-zinc-900 border border-white/10 p-10 rounded-[3rem] flex flex-col items-center text-center">
                            ...
                            <span className="text-sm font-bold text-green-500 uppercase mb-6">{t('greencarpet.co2_avoided')}</span>
                            
                            <div className="grid grid-cols-2 gap-8 w-full border-t border-white/5 pt-8">
                                <div className="flex flex-col">
                                    <span className="text-2xl font-black">85k</span>
                                    <span className="text-[10px] text-white/30 uppercase">{t('greencarpet.kilometers')}</span>
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-2xl font-black">12.4k</span>
                                    <span className="text-[10px] text-white/30 uppercase">{t('greencarpet.journeys')}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            {[
                                { icon: TreePine, title: t('greencarpet.trees_title'), desc: t('greencarpet.trees_desc'), color: 'text-green-400' },
                                { icon: Droplets, title: t('greencarpet.liters_title'), desc: t('greencarpet.liters_desc'), color: 'text-blue-400' },
                                { icon: Globe, title: t('greencarpet.emissions_title'), desc: t('greencarpet.emissions_desc'), color: 'text-orange-400' }
                            ].map((item, i) => (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-zinc-900 border border-white/10 p-10 rounded-[3rem] flex flex-col items-center">
                            ...
                            <span className="text-xs font-bold text-green-500 uppercase">{t('greencarpet.your_co2')}</span>
                        </div>

                        {/* Achievements */}
                        <div className="bg-green-500 p-8 rounded-[3rem] text-black shadow-lg shadow-green-500/20">
                            <ShieldCheck size={40} className="mb-4" />
                            <h3 className="text-2xl font-black uppercase italic tracking-tighter mb-2">{t('greencarpet.eco_elite')}</h3>
