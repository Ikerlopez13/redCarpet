  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/70 backdrop-blur-sm z-50">
      <div className="bg-zinc-900/90 rounded-2xl p-6 w-80 text-center border border-primary/30 shadow-xl animate-fade-in">
        <h2 className="text-xl font-bold mb-4 text-white">{t('alert.title', { type })}</h2>
        <p className="text-sm text-white/70 mb-6">{t('alert.confirm_question')}</p>
