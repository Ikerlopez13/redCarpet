...
export async function searchPlaces(
    ...
    // Bias results towards Barcelona area
    if (proximity) {
        params.append('proximity', `${proximity.lng},${proximity.lat}`);
    } else {
        // Default to Barcelona center
        params.append('proximity', '2.1890,41.4088');
    }

    // Limit to Spain/Barcelona area
    params.append('bbox', '1.5,40.5,3.5,42.5');
